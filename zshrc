...
alias jlabup="jupyter lab --ip=`echo $(curl -s http://169.254.169.254/metadata/v1/interfaces/public/0/anchor_ipv4/address)` --certfile=~/.jupyter/.cert --key=~/.jupyter/.key"
